...
class StarCraft2Env(MultiAgentEnv):
    ...
    def step(self, actions):
        ...
        info = {"battle_won": False, "reward_positive": reward_positive, "reward_negative": reward_negative}
        ...
        if game_end_code is not None:
            ...
            if game_end_code == 1 and not self.win_counted:
                ...
                if not self.reward_sparse:
                    ...
                    info["reward_negative"] -= self.reward_defeat
                else:
                    reward = -1
                    info["reward_positive"] = -1
        ...
        if self.reward_scale:
            ...
            info["reward_negative"] /= self.max_reward / self.reward_scale_rate
        self.reward = reward
