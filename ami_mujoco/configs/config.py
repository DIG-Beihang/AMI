...
def get_config():
    ...
    parser.add_argument("--adv_algorithm_name", type=str, 
                    default='', choices=["mappo_iclr", "mappo_usenix", "mappo_icml", "mappo_ami", "mappo_fgsm"])               
    ...
    parser.add_argument("--epsilon_state", type=float, 
                        default=0.01, help='epsilon of state transition model')
    parser.add_argument("--epsilon_action", type=float, 
                        default=0.05, help='epsilon of action transition model')

    # AMI arguments
    parser.add_argument("--maa_lr", type=float,
                        default=5e-6, help='maa learning rate (default: 5e-6)')
    parser.add_argument("--oracle_lr", type=float, 
                        default=5e-6, help='oracle learning rate (default: 5e-6)')
    parser.add_argument("--oracle_critic_lr", type=float, 
                        default=5e-3, help='oracle critic learning rate (default: 5e-3)')
    ...
    parser.add_argument("--attack_use_recurrent", action='store_true',
                        default=False, help='if maa and oracle use recurrent policy')
    parser.add_argument("--ami_param", type=float,
                        default=1, help='the coefficient of AMI')
    ...
    parser.add_argument("--use_oracle_prob", action="store_true",
                        default=False, help='if AMI use oracle probs')

    # state arguments
    parser.add_argument("--state_adv_mode", action="store_true",
                        default=False, help='if use fgsm in training process')
    ...
    parser.add_argument("--iteration", type=int, default=30, help='fgsm iterations')
